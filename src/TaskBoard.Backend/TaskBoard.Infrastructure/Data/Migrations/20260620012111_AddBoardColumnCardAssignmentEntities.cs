...
{
    /// <inheritdoc />
    public partial class AddBoardColumnCardAssignmentEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CardAssignments_WorkspaceMembers_WorkspaceMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CardAssignments_CardId_WorkspaceMemberId",
                table: "CardAssignments",
                columns: new[] { "CardId", "WorkspaceMemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CardAssignments_WorkspaceMemberId",
                table: "CardAssignments",
